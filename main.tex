...
Otherwise, some two remaining possible occurrences must have a large overlap, and thus induce a periodicity
in the pattern. Then, the two-dimensional case becomes significantly more involved (due to the more complex
nature of two-dimensional periodicities).
The periodicity of the pattern allows us to decompose it into some monochromatic regularly structured fragments.
...
After decomposing the pattern and the text, we then convolve the resulting pairs of monochromatic fragments and sum their contributions.
