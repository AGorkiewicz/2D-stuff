...
\begin{figure}[!t]
	...
	\end{center}
	\caption{All the points form a parquet and the red points form a subparquet.}
...
\begin{definition}[Parquet]\label{parquet_definition}
	...
	For better reference, see \Cref{figure:parquet}.
	\begin{enumerate}[a)]
...
\begin{figure}[!t]
	...
	\end{center}
	\caption{Pattern restriction. TODO}
