...
for $k=\O(\sqrt{m})$, we can achieve quasi-linear time complexity [Gawrychowski and Uznański, ICALP 2018].
...
We improve on these bounds from 30 years ago with a non-trivial adaptation of tools
