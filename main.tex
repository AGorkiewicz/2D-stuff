...
Given a two-dimensional $m \times m$ pattern string $P$ and a two-dimensional $n \times n$ text string $T$, for $m \le n$,
...
In \cref{sec:two_periods,sec:partition,sec:algorithm}, we explain the proof in full detail, including the proofs of the main technical results from  
